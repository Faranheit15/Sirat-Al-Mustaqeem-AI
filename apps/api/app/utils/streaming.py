...
from app.services.llm_router import ProviderRouter
...
def _append_assistant_delta(previous: str, delta: str) -> str:
...
async def chat_event_generator(
    ...
    try:
        async for delta in provider_router.stream_chat(request.messages):
            assistant_content = _append_assistant_delta(assistant_content, delta)
